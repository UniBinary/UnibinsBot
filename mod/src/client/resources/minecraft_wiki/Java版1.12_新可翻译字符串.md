...
*页面ID: 30209* | *来源: Minecraft Wiki*

下面列出了在[Java版1.12](Java版1.12.md)中新增的可翻译字符串。这些字符串在先前的版本中都被硬编码于游戏内。
...
[en:Java Edition 1.12/New translatable strings](en:Java Edition 1.12/New translatable strings.md)
[ja:Java Edition 1.12/新しい翻訳可能な文字列](ja:Java Edition 1.12/新しい翻訳可能な文字列.md)