...
/* Minerva fix */
body.skin-minerva h1,
body.skin-minerva h2,
body.skin-minerva h3,
body.skin-minerva h4,
body.skin-minerva h5,
body.skin-minerva h6,
...
body.wgl-theme-light.page-China_Edition_Wiki .mp-wrapper,
body.wgl-theme-light .mp-portal-china {
	--button-color-progressive: #83ac23;
}
body.wgl-theme-dark.page-China_Edition_Wiki .mp-wrapper,
body.wgl-theme-dark .mp-portal-china {
	--button-color-progressive: #778f4d;
}
...
/* [File:Bedrock_Edition_App_Store_icon_2.png](File:Bedrock_Edition_App_Store_icon_2.png.md) */
.mp-portal-minecraft {
	--button-image: url(https://zh.minecraft.wiki/images/Bedrock_Edition_App_Store_icon_2.png);
}

/* [File:Dungeons.png](File:Dungeons.png.md) */
.mp-portal-dungeons {
	--button-image: url(https://zh.minecraft.wiki/images/Dungeons.png);
}

/* [File:Icon_Legends.png](File:Icon_Legends.png.md) */
.mp-portal-legends {
	--button-image: url(https://zh.minecraft.wiki/images/Icon_Legends.png);
}

/* [File:Icon_Earth.png](File:Icon_Earth.png.md) */
.mp-portal-earth {
	--button-image: url(https://zh.minecraft.wiki/images/Icon_Earth.png);
}

/* [File:Icon_Story_Mode.png](File:Icon_Story_Mode.png.md) */
.mp-portal-story-mode {
	--button-image: url(https://minecraft.wiki/images/Icon_Story_Mode.png);
}

/* [File:Icon_China_Edition.png](File:Icon_China_Edition.png.md) */
.mp-portal-china {
	--button-image: url(https://zh.minecraft.wiki/images/Icon_China_Edition.png);
}
...
@media screen and (max-width: 500px) {
	...
	body.mediawiki .mp-portal-china.mp-portal-active > a > span {
		max-width: 45px;
		line-break: normal;
        line-height: 1.1em;
	}
...
.mp-button.mp-social-bilibili {
	background-color: #009fd4;
}
.mp-button.mp-social-qq {
	background-color: #1ebafc;
}
.mp-button.mp-social-weibo {
...
/**
  ...
  * [Category:模板样式](Category:模板样式.md)
  **/